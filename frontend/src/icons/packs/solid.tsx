...
export const solidPack: IconPack = {
  ...
  trash: (props) => (
    <svg {...base(props)}>
      <path d="M9 2.5h6a1.5 1.5 0 0 1 1.5 1.5v1h4v2h-1.2l-1 13.4a2.5 2.5 0 0 1-2.5 2.3H8.2a2.5 2.5 0 0 1-2.5-2.3L4.7 7H3.5V5h4V4A1.5 1.5 0 0 1 9 2.5Zm0 2V5h6V4.5H9ZM9.5 10v8h1.5v-8H9.5Zm3.5 0v8H15v-8h-2Z" />
    </svg>
  ),
  calendar: (props) => (
    <svg {...base(props)}>
      <path d="M8 2v2.5H6A2 2 0 0 0 4 6.5V9h16V6.5a2 2 0 0 0-2-2h-2V2h-2v2.5H10V2H8Z" />
      <path d="M4 10.5V19a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-8.5H4Z" />
    </svg>
  ),
  checklist: (props) => (
    <svg {...base(props)}>
      <path d="M4 3.5a1 1 0 0 0-1 1v6.4a1 1 0 0 0 1 1h6.4a1 1 0 0 0 1-1V4.5a1 1 0 0 0-1-1H4Zm1.6 3.6 1.3 1.3 2.7-2.8 1.1 1.1-3.8 3.8L4.5 8.1l1.1-1Z" />
      <path d="M14 5.3h7v2h-7Z" />
      <path d="M4 13.5a1 1 0 0 0-1 1v6.4a1 1 0 0 0 1 1h6.4a1 1 0 0 0 1-1v-6.4a1 1 0 0 0-1-1H4Zm1.6 3.6 1.3 1.3 2.7-2.8 1.1 1.1-3.8 3.8-2.4-2.4 1.1-1Z" />
      <path d="M14 15.3h7v2h-7Z" />
    </svg>
  ),
};
